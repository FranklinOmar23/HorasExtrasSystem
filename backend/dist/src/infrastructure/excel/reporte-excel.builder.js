...
exports.nombreArchivoReporteExcel = nombreArchivoReporteExcel;
...
const MARCA = '0E7A6F';
const MARCA_OSCURO = '07433D';
const GRIS_BANDA = 'F5F3ED';
const GRIS_BORDE = 'E4E0D6';
function aFechaISO(fecha) {
    return fecha.toISOString().slice(0, 10);
}
function rangoLegible(inicio, fin) {
...
function nombreArchivoReporteExcel(reporte) {
...
async function construirReporteExcel(reporte) {
    ...
    reporte.filas.forEach((fila, indice) => {
        ...
        valores.forEach((valor, i) => {
            ...
            celda.value = valor;
            if (COLUMNAS[i].formato)
                celda.numFmt = COLUMNAS[i].formato;
